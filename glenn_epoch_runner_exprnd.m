function [time_full,conc_full,time_norm,conc_norm,time_end,conc_end,avg_ep,eplen,epochstep,epochmax,philist,taulist,final_epoch,br,dr,alp,bet,gam,del,fomut,bamut] = glenn_epoch_runner_exprnd(eplen,epochstep,epochmax,philist,taulist,br,dr,alp,bet,gam,del,fmut,bmut,inits,tolrnc)
% Solves simple competition serial transfer experiment (with epochs drawn from an exponential distribution) of phage strains differing in lysogeny rates and decision mechanisms, using glenn_solver().
