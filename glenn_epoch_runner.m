...
function [time_full,conc_full,time_norm,conc_norm,time_end,conc_end,avg_ep,eplen,epochstep,epochmax,philist,taulist,final_epoch,br,dr,alp,bet,gam,del,fomut,bamut] = glenn_epoch_runner(eplen,epochstep,epochmax,philist,taulist,br,dr,alp,bet,gam,del,fmut,bmut,inits,tolrnc)
% Solves simple competition equation of phage strains differing in lysogeny rates and decision mechanisms.
