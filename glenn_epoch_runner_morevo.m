function [time_full,conc_full,time_norm,conc_norm,time_end,conc_end,avg_ep,eplen,epochstep,epochmax,philist,taulist,final_epoch,br,dr,alp,bet,gam,del,fomut,bamut] = glenn_epoch_runner_morevo(eplen,epochstep,epochmax,philist,taulist,br,dr,alp,bet,gam,del,fmut,bmut,inits,tolrnc)
% Solves simple serial transfer experiment equation of phage strains differing in lysogeny rates and decision mechanisms, using glenn_solver_mevo().
    ...
    while epoch<epochmax && close_nuff < 100*(eplen/dt)*(1+2*num)
        ...
        y = glenn_solver_mevo(b,d,alpha,beta,gamma,delta,phis,taus,fomut,bamut,t,init_x');      
        y(y<0)=0;
